        ...
        <form onSubmitCapture={submitForm} className="c-form">
            ...
            <fieldset className="c-form__field">
                <label className="c-form__label" aria-describedby="addressInfoLabel">
                    ...
                    <input type="text" name="address" autoComplete="on" className="c-form__input" value={formInputs.address} onChange={handleInputChange} required pattern={isIE11.current ? undefined : "^(?!\\s+)[\\w\\s]+"} placeholder="Israel Tel-Aviv Pinsker 15" />
